...
Sources: current `origin/main` code, maintainer-provided UI screenshots reviewed
outside the repository, and the design-system refactor brief. Screenshots and
other review artifacts must not be committed.
